...
export const moduleCrudSchemas: Record<string, ModuleCrudSchema> = {
  ...
  "/medical-validity": {
    ...
    fields: [
      ...
      { key: "validUntil", label: "Valid Until", type: "date", required: true },
      {
        ...
        label: "Fit State",
        type: "select",
        options: ["Fit", "Temporary Unfit", "Unfit"],
      },
    ],
  },
  ...
  "/occupational-health": {
    ...
    fields: [
      { key: "aircrew", label: "Aircrew", type: "text", required: true },
      {
        ...
        label: "Exposure Type",
        type: "select",
        options: ["Noise", "Chemical", "Heat", "Radiation"],
        required: true,
      },
      {
        key: "exposureLevel",
  ...
  "/currency-status": {
    ...
    fields: [
      { key: "pilot", label: "Pilot", type: "text", required: true },
      {
        ...
        label: "Currency",
        type: "select",
        options: ["Night", "Instrument", "Formation", "Low Level"],
        required: true,
      },
    ...
    fields: [
      {
        ...
        label: "Event Type",
        type: "select",
        options: ["G-LOC", "Hypoxia", "Barotrauma", "Lainnya"],
        required: true,
      },
      { key: "crew", label: "Crew", type: "text", required: true },
      {
    ...
    fields: [
      {
        ...
        label: "Alert Type",
        type: "select",
        options: ["Training Expiry", "Medical Expiry", "High Risk"],
        required: true,
      },
    ...
    fields: [
      {
        ...
        label: "Role",
        type: "select",
        options: ["Dokter", "Pilot", "Ops", "Komandan"],
        required: true,
      },
      { key: "module", label: "Module", type: "text", required: true },
      {
        ...
        label: "Permission",
        type: "select",
        options: ["Read", "Write", "Approve", "Admin"],
      },
  ...
  "/offline-sync": {
    ...
    fields: [
      ...
      { key: "lastUpdated", label: "Last Updated", type: "date" },
      {
        ...
        type: "select",
        options: ["None", "Local Wins", "Remote Wins", "Manual Merge"],
      },
  ...
  "/mission-intake-hub": {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Priority",
        type: "select",
        options: ["Routine", "Important", "Urgent", "Critical"],
        required: true,
      },
  ...
  "/mission-execution-watch": {
    ...
    fields: [
      ...
      { key: "eventTime", label: "Event Time", type: "date" },
      {
        ...
        label: "Event Type",
        type: "select",
        options: ["Comms", "Weather Shift", "Aircraft", "Medical", "Safety"],
        required: true,
      },
  ...
  "/lessons-learned-fusion": {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Source",
        type: "select",
        options: ["Debrief", "Incident", "Training", "ORM"],
        required: true,
      },
  ...
  "/aerophysiology-hardware-inventory": {
    entityName: "Aerophysiology Device",
    statuses: ["Operational", "Limited", "Maintenance", "Out of Service"],
    fields: [
      {
        key: "deviceName",
      ...
      { key: "nextCalibration", label: "Kalibrasi Berikutnya", type: "date" },
    ],
  },
  "/aerophysiology-training-programs": {
    entityName: "Aerophysiology Training Program",
    statuses: ["Planned", "Open", "Completed", "Deferred"],
    fields: [
      {
        key: "programType",
        label: "Jenis Program",
      ...
      { key: "instructor", label: "Instruktur", type: "text", required: true },
      { key: "batchCode", label: "Batch Code", type: "text" },
      { key: "scheduledDate", label: "Jadwal Pelaksanaan", type: "date" },
    ],
  },
  "/clinical-equipment-inventory": {
    entityName: "Clinical Equipment",
    statuses: ["Operational", "Limited", "Maintenance", "Out of Service"],
    fields: [
      {
        key: "equipmentName",
      ...
      { key: "nextMaintenance", label: "Maintenance Berikutnya", type: "date" },
    ],
  },
  "/quality-maintenance-governance": {
    entityName: "Quality Maintenance Item",
    statuses: ["Open", "In Review", "Compliant", "Non-Compliant"],
    fields: [
      {
        key: "standardRef",
      ...
      {
        key: "deviceScope",
        label: "Ruang Lingkup Perangkat",
        type: "text",
        required: true,
      },
      { key: "finding", label: "Temuan / Catatan", type: "textarea" },
      { key: "owner", label: "PIC", type: "text" },
    ],
  },
  "/regulatory-compliance-matrix": {
    entityName: "Regulatory Matrix Row",
    statuses: ["Compliant", "Partial", "Gap", "Not Applicable"],
    fields: [
      {
        key: "regulation",
        label: "Regulasi",
        type: "select",
        options: [
          "CASR Part 67 / PM 69-2017",
          "KP 250/2017",
          "Permenkes 24/2020",
          "Permenkes 15/2023",
          "BAPETEN No. 1 Tahun 2025",
        ],
        required: true,
      },
      {
        key: "domain",
        label: "Domain Layanan/Perangkat",
        type: "text",
        required: true,
      },
      { key: "statusNote", label: "Status Kepatuhan", type: "textarea" },
      { key: "evidenceLink", label: "Link Evidence", type: "text" },
    ],
  },
  "/software-visibility-register": {
    entityName: "Software Visibility Entry",
    statuses: ["Published", "Limited", "Unspecified"],
    fields: [
      {
        key: "systemName",
        label: "Sistem/Perangkat",
        type: "text",
        required: true,
      },
      {
        key: "softwareClass",
        label: "Kelas Software",
        type: "select",
        options: [
          "Control Software",
          "Monitoring Console",
      ...
      {
        key: "visibility",
        label: "Visibilitas Detail",
        type: "select",
        options: ["Published", "Partially Known", "Unspecified"],
        required: true,
      },
      { key: "assumption", label: "Asumsi/Limitasi", type: "textarea" },
    ],
  },
